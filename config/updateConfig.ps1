...
((Get-Content -Path '..\apiNihongo\src\main\resources\application.properties' -Raw) -replace 'DB_HOST',$config.db_host) | Set-Content -Path '..\apiNihongo\src\main\resources\application.properties'
