...
{
    ((Get-Content -Path ..\apiNihongo\src\main\java\com\thepaut49\nihongo\controller\user\$file -Raw) -replace $config.host_name,'HOST_NAME') | Set-Content -Path ..\apiNihongo\src\main\java\com\thepaut49\nihongo\controller\user\$file
    ((Get-Content -Path ..\apiNihongo\src\main\java\com\thepaut49\nihongo\controller\user\$file -Raw) -replace $config.front_port,'FRONT_PORT') | Set-Content -Path ..\apiNihongo\src\main\java\com\thepaut49\nihongo\controller\user\$file
}
