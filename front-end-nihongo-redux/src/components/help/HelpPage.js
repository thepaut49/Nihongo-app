  ...
  return (
    <div className="styleHomePage">
      ...
      <div className="howToUseSection">
        <div className="howToUseSectionTitle">
          ...
          <div className="howToUse">
            ...
            <div>
              <ol>
                ...
                <li>
                  When you click on a button the content of the button is added
                  to the text to translate.
                </li>
                <li>
          ...
          <div className="howToUse">
            ...
            <div>
              <ol>
                ...
                <li>
                  When you click on the buttons bellow the text area it will add
                  the content of the button in the text. The quick search button
                  will open a popup to help you to find words or kanjis.
                </li>
                <li>
            ...
            <div>
              <ol>
                <li>
                  ...
                  kanjis identified in the text. When you click on list of words
                  it will display the list of words identified in the text. When
                  you click on list of grammar rules it will display the list of
                  grammar rules identified in the text.
                </li>
                <li>
      ...
      <div className="howToUseSection">
        <div className="howToUseSectionTitle">How to use the search tool</div>
